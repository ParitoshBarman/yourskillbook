...
<html lang="zxx">
   <head>
      <title>Our Certificate :: Yourskill Book</title>
              ...
              <div class="col-md-8">
               <div id="carouselExampleFade" class="carousel slide carousel-fade">
                 <div class="carousel-inner">
                    <div class="carousel-item active"><img src="img/demo-certificate.jpg" class="d-block w-100" alt="..."></div>
                    <div class="carousel-item"><img src="img/demo-certificate-2.jpg" class="d-block w-100" alt="..."></div>
