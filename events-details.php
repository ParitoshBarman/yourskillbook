...
<html lang="zxx">
   <head>
      <title>Events Details :: Yourskill Book</title>
      ...
      <section class="dfbljkdfgbdfg">
       <div class="container">
           <div class="section-title services-title wow animate__animated animate__fadeInUp delay-0-2s">
               <span class="top-title">Latest</span>
               <h2>Our Events</h2>
            </div>
           <div class="row">
					<div class="col-lg-8">
						<div class="blog-details-content sdfjhkdfjhkdfbn">
							<img src="img/bg-testimonial.jpg" class="blog-post-img" alt="Image">
